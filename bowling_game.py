...
class BowlingGame:
    ...
    def roll(self, pins):
        ...
        Takes a number for the pins knocked down in a given roll and adds it as an item in an array
        Increments the number of rolls the player has made each time it is called
    ...
    def score(self):
        ...
        Checks all rolls in the array and uses the frame_index variable to keep track of which frame each roll is for
        Checks if a roll was a strike, spare or open frame and applies the relevant bonus if any
        
        Returns:
            the final calcuated scrore for the game
        """
        score = 0
        frame_index = 0
